...
## Сроки сдачи
На задание даётся **ровно две** попытки сдачи. Сроки попыток уточняйте у преподавателя.
...
* Вы можете сделать **не больше двух** полноценных попыток за всё время сдачи. На усмотрение
