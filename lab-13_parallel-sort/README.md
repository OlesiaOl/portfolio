...
Требуется реализовать алгоритм параллельной сортировки слиянием, аналогичный написанному в лабораторной работе №3.
...
Смотри стандартные требования из предыдущих заданий, название папки и файла — `lab-13_parallel-sort`.

### Детали реализации
* При подключении файла `parallel_sort.hpp` пользователю становится доступна функция `parallel_sort`.
